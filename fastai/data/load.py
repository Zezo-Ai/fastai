...
# %% ../../nbs/02_data.load.ipynb #5def9f21
from ..torch_basics import *
from torch.utils.data.dataloader import _MultiProcessingDataLoaderIter,_SingleProcessDataLoaderIter,_DatasetKind
_loaders = (_MultiProcessingDataLoaderIter,_SingleProcessDataLoaderIter)

# %% ../../nbs/02_data.load.ipynb #7c56636a
def _wif(worker_id):
    set_num_threads(1)
...
# %% ../../nbs/02_data.load.ipynb #4ddc4c4d
def fa_collate(t):
...
# %% ../../nbs/02_data.load.ipynb #9fe79680
def fa_convert(t):
...
# %% ../../nbs/02_data.load.ipynb #0c641f6e
class SkipItemException(Exception):
    "Raised to notify `DataLoader` to skip an item"
    pass

# %% ../../nbs/02_data.load.ipynb #e72bbcf9
...
# %% ../../nbs/02_data.load.ipynb #5f0dcf63
@funcs_kwargs
...
# %% ../../nbs/02_data.load.ipynb #5376964d
