...
# %% ../../nbs/03_data.core.ipynb #e54b795a
from ..torch_basics import *
from .load import *

# %% ../../nbs/03_data.core.ipynb #98d34530
@dispatch
def show_batch(
...
# %% ../../nbs/03_data.core.ipynb #64eb6600
...
# %% ../../nbs/03_data.core.ipynb #3987534a
@dispatch
def show_results(
    x, # Input(s) in the batch
    y, # Target(s) in the batch
...
# %% ../../nbs/03_data.core.ipynb #54b7ff75
_all_ = ["show_batch", "show_results"]

# %% ../../nbs/03_data.core.ipynb #49c891db
_batch_tfms = ('after_item','before_batch','after_batch')

# %% ../../nbs/03_data.core.ipynb #4a3a49eb
...
# %% ../../nbs/03_data.core.ipynb #970bdf27
add_docs(TfmdDL,
...
# %% ../../nbs/03_data.core.ipynb #0f9ac23a
@docs
...
# %% ../../nbs/03_data.core.ipynb #90bd756b
class FilteredBase:
...
# %% ../../nbs/03_data.core.ipynb #12a02071
...
# %% ../../nbs/03_data.core.ipynb #d9487119
add_docs(TfmdLists,
...
# %% ../../nbs/03_data.core.ipynb #f186eb1d
def decode_at(o, idx):
    "Decoded item at `idx`"
    return o.decode(o[idx])

# %% ../../nbs/03_data.core.ipynb #0c41cfde
def show_at(o, idx, **kwargs):
    "Show item at `idx`",
    return o.show(o[idx], **kwargs)

# %% ../../nbs/03_data.core.ipynb #58bc783f
@docs
@delegates(TfmdLists)
...
# %% ../../nbs/03_data.core.ipynb #e6c97c63
def test_set(
...
# %% ../../nbs/03_data.core.ipynb #6f1c883e
@patch
