...
# %% ../nbs/12_optimizer.ipynb #14a42c24
from .torch_basics import *

# %% ../nbs/12_optimizer.ipynb #9902b6ea
...
# %% ../nbs/12_optimizer.ipynb #b7ca4624
def _update(
    state:dict,
...
# %% ../nbs/12_optimizer.ipynb #3ab222f7
...
# %% ../nbs/12_optimizer.ipynb #cf6115b1
def sgd_step(p, lr, **kwargs):
    p.data.add_(p.grad.data, alpha=-lr)

# %% ../nbs/12_optimizer.ipynb #8997a06f
...
# %% ../nbs/12_optimizer.ipynb #6643f4de
...
# %% ../nbs/12_optimizer.ipynb #fa23f2d1
...
# %% ../nbs/12_optimizer.ipynb #7f790600
...
# %% ../nbs/12_optimizer.ipynb #eb466ac7
def momentum_step(p, lr, grad_avg, **kwargs):
    "Step for SGD with momentum with `lr`"
    p.data.add_(grad_avg, alpha=-lr)

# %% ../nbs/12_optimizer.ipynb #1871fb31
def SGD(
    params:Tensor|Iterable, # Model parameters
...
# %% ../nbs/12_optimizer.ipynb #148e2a6b
...
# %% ../nbs/12_optimizer.ipynb #f3cf04dc
def RMSProp(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
    mom:float=0., # Gradient moving average (β1) coefficient
...
# %% ../nbs/12_optimizer.ipynb #c0b57544
def step_stat(p, step=0, **kwargs):
    "Register the number of steps done in `state` for `p`"
    step += 1
    return {'step' : step}

# %% ../nbs/12_optimizer.ipynb #f9c7e85d
def debias(mom, damp, step): return damp * (1 - mom**step) / (1-mom)

# %% ../nbs/12_optimizer.ipynb #f4286b9e
...
# %% ../nbs/12_optimizer.ipynb #b52d9314
def Adam(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
...
# %% ../nbs/12_optimizer.ipynb #55b54504
...
# %% ../nbs/12_optimizer.ipynb #539de04e
def RAdam(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
    mom:float=0.9, # Gradient moving average (β1) coefficient
...
# %% ../nbs/12_optimizer.ipynb #e09a902d
...
# %% ../nbs/12_optimizer.ipynb #44f31f5c
def QHAdam(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
...
# %% ../nbs/12_optimizer.ipynb #f5489b8b
...
# %% ../nbs/12_optimizer.ipynb #84e80614
...
# %% ../nbs/12_optimizer.ipynb #745d9d5a
def Larc(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
    mom:float=0.9, # Gradient moving average (β1) coefficient
...
# %% ../nbs/12_optimizer.ipynb #bc641087
...
# %% ../nbs/12_optimizer.ipynb #18e7d79a
def Lamb(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
    mom:float=0.9, # Gradient moving average (β1) coefficient
...
# %% ../nbs/12_optimizer.ipynb #e52b19a6
...
# %% ../nbs/12_optimizer.ipynb #134973fc
@delegates(RAdam)
def ranger(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
...
# %% ../nbs/12_optimizer.ipynb #49985efc
def detuplify_pg(d):
    res = {}
    for k,v in d.items():
...
# %% ../nbs/12_optimizer.ipynb #8fd09729
...
# %% ../nbs/12_optimizer.ipynb #84a670ee
