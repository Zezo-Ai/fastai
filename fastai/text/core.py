...
# %% ../../nbs/30_text.core.ipynb #4116cfe6
#special tokens
UNK, PAD, BOS, EOS, FLD, TK_REP, TK_WREP, TK_UP, TK_MAJ = "xxunk xxpad xxbos xxeos xxfld xxrep xxwrep xxup xxmaj".split()

# %% ../../nbs/30_text.core.ipynb #a5c23426
_all_ = ["UNK", "PAD", "BOS", "EOS", "FLD", "TK_REP", "TK_WREP", "TK_UP", "TK_MAJ"]

# %% ../../nbs/30_text.core.ipynb #10423b42
...
# %% ../../nbs/30_text.core.ipynb #342cd27d
...
# %% ../../nbs/30_text.core.ipynb #20a624fb
...
# %% ../../nbs/30_text.core.ipynb #f6e38021
_re_wrep = re.compile(r'(?:\s|^)(\w+)\s+((?:\1\s+)+)\1(\s|\W|$)')

# %% ../../nbs/30_text.core.ipynb #7ecee575
def replace_wrep(t):
...
# %% ../../nbs/30_text.core.ipynb #2b43950d
def fix_html(x):
...
# %% ../../nbs/30_text.core.ipynb #572218af
_re_all_caps = re.compile(r'(\s|^)([A-Z]+[^a-z\s]*)(?=(\s|$))')

# %% ../../nbs/30_text.core.ipynb #a938c285
...
# %% ../../nbs/30_text.core.ipynb #29850f4f
_re_maj = re.compile(r'(\s|^)([A-Z][^A-Z\s]*)(?=(\s|$))')

# %% ../../nbs/30_text.core.ipynb #c2177810
def replace_maj(t):
...
# %% ../../nbs/30_text.core.ipynb #34e5abad
def lowercase(t, add_bos=True, add_eos=False):
    "Converts `t` to lowercase"
    return (f'{BOS} ' if add_bos else '') + t.lower().strip() + (f' {EOS}' if add_eos else '')

# %% ../../nbs/30_text.core.ipynb #c192a646
def replace_space(t):
    "Replace embedded spaces in a token with unicode line char to allow for split/join"
    return t.replace(' ', '▁')

# %% ../../nbs/30_text.core.ipynb #c77dbdd9
...
# %% ../../nbs/30_text.core.ipynb #4bf29621
class BaseTokenizer():
...
# %% ../../nbs/30_text.core.ipynb #57ee3427
...
# %% ../../nbs/30_text.core.ipynb #d9b13d89
WordTokenizer = SpacyTokenizer

# %% ../../nbs/30_text.core.ipynb #5d4e97ca
...
# %% ../../nbs/30_text.core.ipynb #4a82d24e
...
# %% ../../nbs/30_text.core.ipynb #5406c366
...
# %% ../../nbs/30_text.core.ipynb #6b5f0975
...
# %% ../../nbs/30_text.core.ipynb #6e2d7f7a
...
# %% ../../nbs/30_text.core.ipynb #e976b8ab
...
# %% ../../nbs/30_text.core.ipynb #0be3f7d9
...
# %% ../../nbs/30_text.core.ipynb #33f20169
...
# %% ../../nbs/30_text.core.ipynb #ddee3fe4
...
# %% ../../nbs/30_text.core.ipynb #b1be4363
...
# %% ../../nbs/30_text.core.ipynb #acd353be
eu_langs = ["bg", "cs", "da", "de", "el", "en", "es", "et", "fi", "fr", "ga", "hr", "hu",
            "it","lt","lv","mt","nl","pl","pt","ro","sk","sl","sv"] # all European langs

# %% ../../nbs/30_text.core.ipynb #c0fef4e9
